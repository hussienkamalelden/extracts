...
public class ExistExtracts extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custom_adapter =new Adapter(context,catcher_arr,"Extracts"); // send context in parameter ..
    ...
    public void updateRecyclerView() {
        try {
            File f = new File(android.os.Environment.getExternalStorageDirectory().getAbsolutePath() + "/Extracts");
            f.mkdirs();
